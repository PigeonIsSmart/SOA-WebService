...
public class JerseyClient {
	...
	WebResource resource2 = client.resource(baseUrl);
	getAllDemo(resource);
	...
	String url2 = baseUrl + "?id=10";
	resource2 = client.resource(url2);
	getOneDemo(resource2);
	deleteDemo(resource2); // delete id = 10
    }
